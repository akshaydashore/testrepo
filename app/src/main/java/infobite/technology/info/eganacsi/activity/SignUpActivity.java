...
import infobite.technology.info.eganacsi.util.NetworkConstants;
...
public class SignUpActivity extends AppCompatActivity implements
    ...
    private String personName,personPhotoUrl,id,email;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_register);
        btnSignIn = (ImageView) findViewById(R.id.gmail_image);
        ...
        Auth.GoogleSignInApi.signOut(mGoogleApiClient).setResultCallback(
                new ResultCallback<Status>() {
                    ...
                    public void onResult(Status status) {
                        Log.e(TAG, "onResult: " + "logout after getting data");
                    }
                });
    }
